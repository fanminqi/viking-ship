...
describe('test Input component', () => {
  ...
  it('should render different input sizes on size property', () => {
    ...
    const testNode = screen.getByPlaceholderText('sizes') as HTMLInputElement
    /* eslint-disable testing-library/no-node-access */
    const testContainer = testNode.closest('.viking-input-wrapper') as HTMLElement | null
  ...
  it('should render prepand and append element on prepand/append property', () => {
    ...
    const testNode = screen.getByPlaceholderText('pend') as HTMLInputElement
    /* eslint-disable testing-library/no-node-access */
    const testContainer = testNode.closest('.viking-input-wrapper') as HTMLElement | null
    /* eslint-enable testing-library/no-node-access */

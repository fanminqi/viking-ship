...
export var Form = forwardRef(function (props, ref) {
    var _a = props.name, name = _a === void 0 ? "viking-form" : _a, children = props.children, initialValues = props.initialValues, onFinish = props.onFinish, onFinishFailed = props.onFinishFailed;
    var _b = useStore(initialValues), fields = _b.fields, form = _b.form, dispatch = _b.dispatch, restProps = __rest(_b, ["fields", "form", "dispatch"]);
